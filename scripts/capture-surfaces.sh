#!/usr/bin/env bash
# Capture Today, WHOOP stack, Body & activity, Settings, Check-in, History, rings, sleep quality, and sleep debt via XCUITest.
...
for f in verify-dashboard.png verify-whoop-stack.png verify-body-activity.png verify-settings-sources.png verify-rings.png verify-sleep-quality.png verify-sleep-debt.png verify-checkin.png verify-history.png; do
