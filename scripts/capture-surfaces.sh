...
for f in verify-dashboard.png verify-whoop-stack.png verify-body-activity.png verify-body-detail.png verify-body-cycle.png verify-settings-sources.png verify-rings.png verify-ring-detail.png verify-sleep-quality.png verify-sleep-debt.png verify-checkin.png verify-history.png verify-journal.png verify-journal-impact.png verify-sleep-disturbances.png verify-weekly-report.png verify-sleep-stages.png verify-metric-detail-scrub.png verify-metric-detail-classic-scrub.png verify-strain-recovery.png verify-strain-wheel.png verify-recommendations.png verify-coaching.png verify-sleep-performance.png verify-sleep-hrv.png verify-respiratory.png verify-skin-temp.png verify-trends.png verify-day-detail.png verify-home-widget.png verify-home-widget-large.png verify-home-widget-extra-large.png verify-home-widget-updated.png verify-home-widget-live-updated.png verify-home-widget-small-updated.png verify-home-widget-checkin.png verify-home-widget-deeplinks.png verify-lock-widget.png verify-lock-widget-rectangular.png verify-lock-widget-inline.png verify-watch-dashboard.png verify-watch-strain.png verify-watch-complication.png verify-watch-complication-rectangular.png verify-watch-complication-inline.png verify-watch-complication-corner.png verify-watch-checkin.png verify-watch-sleep.png; do
