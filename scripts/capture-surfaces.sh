#!/usr/bin/env bash
# Capture Today, WHOOP stack, Body & activity, Settings, Check-in, History, Journal, rings, sleep quality, sleep debt, and sleep disturbances via XCUITest.
...
for f in verify-dashboard.png verify-whoop-stack.png verify-body-activity.png verify-settings-sources.png verify-rings.png verify-sleep-quality.png verify-sleep-debt.png verify-checkin.png verify-history.png verify-journal.png verify-sleep-disturbances.png; do
