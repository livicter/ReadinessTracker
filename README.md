...
Medium / large / extra-large Home widgets surface Fitness-style **Updated …** from App Group `lastUpdate` (`WidgetDataExporter`); cue hides gracefully when the key is missing. Lock accessories stay uncluttered.
