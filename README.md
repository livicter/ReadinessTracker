...
| Watch dashboard hero (Gym / Work / Sleep + HRV\|RHR) | Shipped. Concentric Activity rings + elevated HRV\|RHR dual callout and Ready/Recovery cue on Watch glance; `WatchSnapshot` carries gym/work/sleep + vitals from WatchConnectivity | [verify-watch-dashboard.png](.audit/verify-watch-dashboard.png) |
