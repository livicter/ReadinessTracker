...
enum SurfaceID {
    ...
    static let dayDetailMetricCorrelationSleepRHR = "day.detail.metricCorrelation.sleepRhr"
    /// Honest #325: Day Detail MetricCorrelationView Sleep↔Strain (extends #270/#310/#324).
    static let dayDetailMetricCorrelationSleepStrain = "day.detail.metricCorrelation.sleepStrain"
    /// Honest #339: Day Detail MetricCorrelationView HRV↔Strain (extends #270/#310/#324/#325).
    static let dayDetailMetricCorrelationHRVStrain = "day.detail.metricCorrelation.hrvStrain"
    /// Honest #340: Day Detail MetricCorrelationView RHR↔Strain (extends #339; completes Strain correlation pair).
    static let dayDetailMetricCorrelationRHRStrain = "day.detail.metricCorrelation.rhrStrain"
    /// Honest #342: Day Detail MetricCorrelationView Sleep↔SpO2 (extends #325 Sleep↔Strain; SpO2 correlation cluster).
    static let dayDetailMetricCorrelationSleepSpo2 = "day.detail.metricCorrelation.sleepSpo2"
    /// Honest #343: Day Detail MetricCorrelationView HRV↔SpO2 (extends #342 Sleep↔SpO2; SpO2 correlation cluster).
    static let dayDetailMetricCorrelationHRVSpo2 = "day.detail.metricCorrelation.hrvSpo2"
    ...
    static let dayDetailStrainMA14 = "day.detail.strain.ma14"
    static let dayDetailStrainEMA = "day.detail.strain.ema"
    /// Honest #321: Day Detail Strain rollingVolatility strip (Sleep #276 / HRV #291 / RHR #305 dual; strip triad start).
    static let dayDetailStrainVolatility = "day.detail.strain.volatility"
    static let dayDetailStrainVolatilityToggle = "day.detail.strain.volatility.toggle"
    /// Honest #322: Day Detail Strain momentum strip (Sleep #277 / HRV #292 / RHR #306 dual).
    static let dayDetailStrainMomentum = "day.detail.strain.momentum"
    static let dayDetailStrainMomentumToggle = "day.detail.strain.momentum.toggle"
    /// Honest #323: Day Detail Strain Day Δ / rateOfChange strip (Sleep #278 / HRV #293 / RHR #307 dual; triad complete).
    static let dayDetailStrainDayDelta = "day.detail.strain.dayDelta"
    static let dayDetailStrainDayDeltaToggle = "day.detail.strain.dayDelta.toggle"
    /// Honest #326: Day Detail SmartInsightsView on SpO2 (Sleep #267 / Strain #311 dual; SpO2 track entry).
    static let dayDetailSpO2SmartInsights = "day.detail.spo2.smartInsights"
    /// Honest #327: Day Detail WeeklyPatternView on SpO2 (Sleep #268 / Strain #312 dual; ≥7).
    ...
    /// Honest #336: Day Detail SpO2 rollingVolatility strip (Sleep #276 / Strain #321 dual; strip triad start).
    static let dayDetailSpO2Volatility = "day.detail.spo2.volatility"
    static let dayDetailSpO2VolatilityToggle = "day.detail.spo2.volatility.toggle"
